...
See metadata about the dataset and extracted projects following [this link](metadata.md).

## FAIR principle

The details of FAIR principles are available following [this link](https://snail.info.unamur.be/course/infob302ids/chapitre10/#open-data).
...
- I1 : Data is stored in CSV format, an open and widely used standard
- I2 : Vocabulary complies with fair principles and explicit names
- I3 : (Meta)data includes qualified references to other (meta)data and Github repositories.

### Reusable

- R1 : (Meta)data offer a great variability along with a MIT license : [to see the license ](LICENSE)
